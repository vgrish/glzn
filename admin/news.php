...
<div class="app app-header-fixed">
    <?
    include "view/tpl_popup_news.php";
    include "view/header.php";
	$active_a = "class=\"active\""; include "view/nav.php"; ?>
	<!-- content -->
			...
			<div class="hbox hbox-auto-xs hbox-auto-sm">
				<div class="col">
					<div class="bg-light lter b-b wrapper-md wrapper-md__i">
						<h1 class="m-n font-thin h3 inline"><?=($records==false)?"Не найдено":"Новости"?></h1>
					</div>
										...
										<div class="table-responsive">
											<table class="table table-striped b-t b-light">
												...
												foreach ($records as $record) {
													?>
													<tr>
														<td><?=data_russian(date_exp($record["date"]))?></td>
														<td><?=$record["title"]?></td>
														<td><?=$record["text"]?></td>
														<td>
															...
															btn-xs
															btn-danger" onclick="return confirm('Удалиь?');"><i
